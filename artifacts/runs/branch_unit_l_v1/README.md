...
```powershell
python "D:\sdxl\chanzhi_sw_clean\experiments\branch_unit\run_l.py" score --run-dir "D:\sdxl\chanzhi_sw_clean\artifacts\runs\branch_unit_l_v1" --review "D:\sdxl\chanzhi_sw_clean\artifacts\runs\branch_unit_l_v1\blind_review_round1.json"
```
